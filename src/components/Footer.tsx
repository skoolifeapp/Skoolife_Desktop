    ...
    <footer className="bg-foreground text-background">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12">
          ...
          <p className="text-lg md:text-xl font-medium text-background/80">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/features/calendar" className="text-sm text-background/70 hover:text-background transition-colors">
                  Calendrier
                </Link>
              </li>
              <li>
                <Link to="/features/pomodoro" className="text-sm text-background/70 hover:text-background transition-colors">
                  Pomodoro
                </Link>
              </li>
              <li>
                <Link to="/features/progression" className="text-sm text-background/70 hover:text-background transition-colors">
                  Progrès
                </Link>
              </li>
              <li>
                <Link to="/features/subjects" className="text-sm text-background/70 hover:text-background transition-colors">
                  Matières
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <button className="px-4 py-2 rounded-lg bg-background text-foreground text-sm font-medium hover:bg-background/90 transition-colors">
                S'abonner
              </button>
            </div>
            ...
            <div className="flex items-center gap-2 mt-6">
              <span className="text-sm text-background/70">Operational</span>
